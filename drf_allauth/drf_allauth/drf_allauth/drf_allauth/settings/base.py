...
REST_AUTH = {
    'SERIALIZER':
        {
            ...
            'USER_DETAILS_SERIALIZER': 'user_auth.serializers.CustomRegisterSerializer',
    ...
    'PERMISSION':
        {
            'REGISTER_PERMISSION_CLASSES': ('rest_framework.permissions.IsAuthenticated',)
        },
    ...
    'JWT_AUTH_HTTPONLY': False,  # if true then refresh_token will not be sent
...
# If mandatory then reverse_not_found error occurs while registration (problem1)
ACCOUNT_EMAIL_VERIFICATION = 'none'
ACCOUNT_CONFIRM_EMAIL_ON_GET = False
LOGIN_URL = 'http://localhost:8000/auth/login'
CUSTOM_PASSWORD_RESET_CONFIRM = 'http://localhost:8000'
# ***************************
